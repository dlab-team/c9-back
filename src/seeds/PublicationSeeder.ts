...
import { CategoryTypes, Publication } from "../entity/Publication";
...
export class PublicationSeeder implements Seeder{
    async run(dataSource: DataSource, factoryManager: SeederFactoryManager): Promise<any> {
        ...
        const publicationData = [{
            ...
            images : ['https://images.ecestaticos.com/eFSB4vJG5Ii1Wdu8fKaw2mQCL8Y=/0x0:1174x893/1200x1200/filters:fill(white):format(jpg)/f.elconfidencial.com%2Foriginal%2Facf%2F4a7%2F72c%2Facf4a772cb60541c5da9988ab6a84e19.jpg',
            'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/Triceratops_BW.jpg/640px-Triceratops_BW.jpg',
            'https://imagenes.elpais.com/resizer/Z7P8ZoQpeKAqVRTlYnCYuf3m40g=/1960x1470/cloudfront-eu-central-1.images.arcpublishing.com/prisa/YPPJ2LC55BFJTAWLFXHZRKUPSM.jpg'],
            user : {
                id: 1
            }
        },{
