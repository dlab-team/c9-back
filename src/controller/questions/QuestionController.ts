...
export class QuestionController {
  ...
  async one(request: Request, response: Response, next: NextFunction) {
    try {
      ...
      response.json({
        message: "Ha ocurrido un error trayendo una pregunta",
        error: error.detail,
      });
    }
  }
  ...
  async save(request: Request, response: Response, next: NextFunction) {
    try {
      ...
      response.json({
        message: "Ha ocurrido un error creando una pregunta con su respuesta",
        error: error.detail,
      });
    }
  }
  ...
  async remove(request: Request, response: Response, next: NextFunction) {
    try {
      ...
      if (!questionToRemove) {
        response.json({
          message: "La pregunta que intenta eliminar no existe",
        });
      }
  ...
  async update(request: Request, response: Response, next: NextFunction) {
    try {
      ...
      if (!questionUpdate) {
        response
          .status(400)
          .json({ message: "No se encontró la pregunta a actualizar" });
        return;
      }
      ...
      response.json({
        message:
          "Ha ocurrido un error actualizando una pregunta con su respuesta",
        error: error.detail,
      });
    }
  }
