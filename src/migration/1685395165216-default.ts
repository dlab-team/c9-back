...
export class Default1685395165216 implements MigrationInterface {
    name = 'Default1685395165216'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "publications" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "slug" character varying NOT NULL, "initialContent" text NOT NULL, "finalContent" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "category" "public"."publications_category_enum" NOT NULL DEFAULT 'General', "images" text, "region" text NOT NULL, "city" text NOT NULL, "user_id" integer, CONSTRAINT "UQ_52d5468b54d886ad193b9ade07c" UNIQUE ("name"), CONSTRAINT "PK_2c4e732b044e09139d2f1065fae" PRIMARY KEY ("id"))`);
